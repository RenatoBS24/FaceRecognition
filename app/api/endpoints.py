...
from app.service.recognition import face_recognition_ws, register_face, update_face,test_register,test_face_recognition_image,face_recognition_ws_all
